...
import profileImg from "../../assets/images/maruf.png";
const About = () => {
  return (
    <div className="container my-5">
      <div className="d-flex flex-column flex-lg-row gap-4">
        <img className="rounded-circle w-25 h-50" src={profileImg} alt="" />
        <div>
      ...
      <p className="my-2 p-2">
        ...
        <mark>progdem@gmail.com</mark> or call{" "}
        <mark>+8801834557345</mark>
      </p>
    </div>
  );
};
