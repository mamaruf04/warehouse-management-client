...
import {
  AiFillEdit,
  AiFillFileAdd, AiFillHome,
  AiOutlineAreaChart, AiOutlineHistory, AiOutlineUserAdd, AiOutlineUsergroupAdd
} from "react-icons/ai";
        ...
        <div className="col-12 col-md-3 shadow asid-menu">
          ...
          <div className="side-menu rounded px-2">
            ...
            >
              ...
              <p className="mt-2">Update Quantity & Price</p>
              <p className="ms-auto mt-2">{<MdKeyboardArrowRight />}</p>
            </Link>
          </div>
          <div className="side-menu rounded px-2">
          ...
          <div className="side-menu rounded px-2">
            ...
            >
              ...
              <p className="mt-2">History Log</p>
              <p className="ms-auto mt-2">{<MdKeyboardArrowRight />}</p>
            </Link>
          </div>
          <div className="side-menu rounded px-2">
